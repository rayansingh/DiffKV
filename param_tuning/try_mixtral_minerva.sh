...
python3 _eval_qa_correct.py --model mixtral --dataset minerva_math --model-gen 1 --model-size 56 --log-path ../logs/per_token_thresh/mixtral/minerva/qt0.6_md0.7_none --kbits-high 8 --vbits-high 4 --kbits-low 4 --vbits-low 2 --kv-prune-thresh 0.02 --kv-quant-thresh 0.6 --kv-buffer 64 --rounds 1 --kv-min-distance 0.7 --kv-convergence-mode none
python3 _eval_qa_correct.py --model mixtral --dataset minerva_math --model-gen 1 --model-size 56 --log-path ../logs/per_token_thresh/mixtral/minerva/qt0.6_md0.7_linear --kbits-high 8 --vbits-high 4 --kbits-low 4 --vbits-low 2 --kv-prune-thresh 0.02 --kv-quant-thresh 0.6 --kv-buffer 64 --rounds 1 --kv-min-distance 0.7 --kv-convergence-mode linear
python3 _eval_qa_correct.py --model mixtral --dataset minerva_math --model-gen 1 --model-size 56 --log-path ../logs/per_token_thresh/mixtral/minerva/qt0.6_md0.7_logarithmic --kbits-high 8 --vbits-high 4 --kbits-low 4 --vbits-low 2 --kv-prune-thresh 0.02 --kv-quant-thresh 0.6 --kv-buffer 64 --rounds 1 --kv-min-distance 0.7 --kv-convergence-mode logarithmic
